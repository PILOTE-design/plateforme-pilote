...
// ─── RAPPORT COMPTABLE — les heures d'un mois, telles qu'on les transmet ────
//
...
import { ChevronLeft, ChevronRight, Download, Lock, LockOpen, AlertTriangle, CalendarDays, ChevronDown } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-2xl font-bold text-gray-900">Rapport comptable</h1>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Link href="/dashboard/planning" className="text-sm text-gray-500 hover:text-gray-900 inline-flex items-center gap-1.5">
          <CalendarDays className="w-3.5 h-3.5" />
          Corriger un planning
        </Link>
      </div>
