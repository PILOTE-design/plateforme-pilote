...
export default async function MargesPage() {
  ...
  // Pas de repère de marge — ce n'est pas un métier, juste de l'achat-revente. Il porte
  // en revanche sa part d'heures sans poste : quelqu'un encaisse bien ces produits.
