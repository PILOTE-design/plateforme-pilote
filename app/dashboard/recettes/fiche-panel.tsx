...
import { Pencil, Plus, X, Check, Clock, ShoppingBasket, Package, AlertTriangle, Printer, Copy } from 'lucide-react'
  ...
  return (
    <div className="bg-white rounded-2xl border border-pilote-100 shadow-card-hover overflow-hidden">
      ...
      <div className="p-5">
        ...
        {onglet === 'infos' && <OngletInfos p={{ baseQty, uniteLabel, poids, pertePct, perteHt, c, formats, recipe, employeeName, onSaved }} />}
        ...
        {onglet === 'vente' && <OngletVente p={{ actif, venteQty, uniteVente, pvHTActif, tvaActive, c, pertePct, perteHt, matiereUnite, moUnite, margeBrute, margeNette, foodCostPct, coutUnite, coutIncomplet, nomsSansPrix, formats }} />}

        {onglet === 'stats' && <OngletStats p={{ c, baseQty, venteQty, coutUnite, pvHTActif, margeActive, recipe, jalonsGraphe, uniteVente, series, setSeries, historiqueIncomplet }} />}
